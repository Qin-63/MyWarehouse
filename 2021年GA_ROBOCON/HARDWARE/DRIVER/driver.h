...
void TIM8_Startup(u32 frequency,u8 ch);   //启动定时器8
void Locate_Rle(long num,u32 frequency,DIR_Type dir,u8 ch); //相对定位函数
void Locate_Abs(long num,u32 frequency,u8 ch);//绝对定位函数
